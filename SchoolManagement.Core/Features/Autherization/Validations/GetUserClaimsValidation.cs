...
{
    internal class GetUserClaimsValidation : AbstractValidator<GetUserAndRolesQuery>
    {
        #region Fields
        ...
        #region Constructors
        public GetUserClaimsValidation(IUserService autherizationService, IStringLocalizer<SharedResources> stringLocalizer)
        {
